...
class TagService: TagServiceProtocol {
    ...
    func fetchTags() async throws -> [Tag] {
        return try await networkService.request(.fetchTags, method: .get, parameters: nil)
    }
    ...
    func createTag(name: String, color: String) async throws -> Tag {
        ...
        return try await networkService.request(.createTag, method: .post, parameters: parameters)
    }
    ...
    func updateTag(tag: Tag) async throws -> Tag {
